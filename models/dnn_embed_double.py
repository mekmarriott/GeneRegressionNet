...
class TFDNNDoubleEmbeddingModel(TFModel):
  def __init__(self, embed1_shape, embed2_shape, alpha=0.001, layer_dims=[], combiner=None, opt='sgd', activation=None):
    ...
    layers = [embed1_shape[1] + embed2_shape[1]] + layer_dims + [1]
    self.W = {}
    self.b = {}
